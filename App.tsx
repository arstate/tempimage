...
const App = () => {
  ...
  const downloadWithProgress = async (url: string, name: string, isImage: boolean) => {
    ...
    try {
        // ORIGINAL QUALITY CHANGE: Use direct URL, remove proxy
        // This attempts to fetch the file directly.
        let finalUrl = url;
        ...
        // FALLBACK FOR ORIGINAL QUALITY: 
        // If fetch fails (CORS), opening the URL in a new tab triggers the browser's native download
        // which guarantees the original file from cloud is downloaded.
